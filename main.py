...
CASE_ITEMS = {
    ...
    # ... остальные кейсы можешь оставить как у тебя было ...
    # Я оставлю только starter, чтобы файл не был гигантским.
    # ВСТАВЬ СЮДА ВСЕ СВОИ КЕЙСЫ ИЗ СТАРОГО main.py (bronze, silver, gold, ... titan)
    # Скопируй блок CASE_ITEMS полностью из старого файла и вставь здесь.
}
